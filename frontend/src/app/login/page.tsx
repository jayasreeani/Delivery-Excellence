    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">DP</div>
          <h1 className="text-2xl font-bold text-slate-800">Delivery Platform</h1>
          <p className="text-slate-500 text-sm mt-1">Reporting & Insights</p>
        </div>
        ...
        <div className="mt-6 p-3 bg-slate-50 rounded-lg text-xs text-slate-500">
          ...
          <p>Management: admin@delivery.com</p>
          <p>Client: client@delivery.com</p>
